...
train_loader = DistributedDataLoader(filename_pattern=train_shards_pattern, B=B, T=T, process_rank=ddp_rank, num_processes=ddp_world_size)
val_loader = DistributedDataLoader(filename_pattern=val_shards_pattern, B=B, T=T, process_rank=ddp_rank, num_processes=ddp_world_size)
