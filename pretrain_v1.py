...
# load tokens
input_train_bin: str = "data/fineweb10B/fineweb_train_*.bin"  # input .bin to train on
input_val_bin: str = (
    "data/fineweb10B/fineweb_val_*.bin"  # input .bin to eval validation loss on
)
train_loader = DistributedDataLoader(input_train_bin, B, T, ddp_rank, ddp_world_size)
